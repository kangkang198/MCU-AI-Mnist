                                          ...
                                          uint32_t hfnmi_en)
{
  ...
  mpu->MAIR0 = (MPU_ARMV8M_MAIR_ATTR_CODE_VAL << MPU_MAIR0_Attr0_Pos) |
               (MPU_ARMV8M_MAIR_ATTR_DATANOCACHE_VAL << MPU_MAIR0_Attr1_Pos) |
               (MPU_ARMV8M_MAIR_ATTR_DATA_VAL << MPU_MAIR0_Attr2_Pos) |
               (MPU_ARMV8M_MAIR_ATTR_FDATANOCACHE_VAL << MPU_MAIR0_Attr3_Pos);
    
  mpu->MAIR1 = (MPU_ARMV8M_MAIR_ATTR_DEVICE_VAL << MPU_MAIR1_Attr4_Pos);     
...
enum mpu_armv8m_error_t system_mpu_armv8m_clean(struct mpu_armv8m_dev_t *dev)
{
  ...
  while (i > 0)
  {
    system_mpu_armv8m_region_disable(dev, i - 1);
    i--;
  }
